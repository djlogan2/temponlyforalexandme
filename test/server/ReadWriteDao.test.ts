...
describe("ReadWriteDao", function () {
  ...
  describe("insert", function () {
    it("should work", function () {
      ...
      expect(
        global.ICCServer.collections.readwritedaotest.findOne(),
      ).to.deep.equal({ _id: id, data: "somedata" });
    });
  });
  ...
  describe("remove", function () {
    it("should work", function () {
      ...
      dao.remove(id);
      expect(global.ICCServer.collections.readwritedaotest.findOne()).to.be
        .undefined;
    });
  });
  ...
  describe("removeMany", function () {
    it("should work", function () {
      ...
      expect(
        global.ICCServer.collections.readwritedaotest.find().count(),
      ).to.equal(10);
  ...
  describe("update", function () {
    it("should work", function () {
      ...
      expect(
        global.ICCServer.collections.readwritedaotest.findOne(),
      ).to.deep.equal({ _id: id, data: "moredata" });
    });
  });
