...
globalThis.ICCServer = {
    collections: {},
    utilities: {
        getLogger: (parent: Stoppable, identifier: string) => (new ServerLogger(parent, identifier) as CommonLogger),
        getCollection(collectionname: CollectionNames): Mongo.Collection<any> {
            ...
            return globalThis.ICCServer.collections[collectionname] as Mongo.Collection<any>;
        },
    },
}
