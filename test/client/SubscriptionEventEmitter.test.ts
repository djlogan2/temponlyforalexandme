...
describe("SubscriptionEventEmitter", function() {
    it("needs to be tested", function() {
        ...
        const see = SubscriptionEventEmitter.getSubscriptionEventEmitter("subscriptioneventemittertest");
        expect(subscribecall.notCalled, "SubscriptionEventEmitter 1").to.be.true;
        expect(stopsubscriptioncall.notCalled, "SubscriptionEventEmitter 2").to.be.true;
        ...
        expect(global.ICCServer.subscriptions.subscriptioneventemittertest).instanceof(PooledEventEmitter, "SubscriptionEventEmitter 6");

        see.on("xyz", console.log);
        expect(subscribecall.calledOnce, "SubscriptionEventEmitter 7").to.be.true;
        expect(stopsubscriptioncall.notCalled, "SubscriptionEventEmitter 8").to.be.true;
        ...
        expect(stopsubscriptioncall.calledOnce, "SubscriptionEventEmitter 10").to.be.true;
